...
output$label_input <- renderText({

  if(input$modalidade == "0"){
    saida <- "Departamento Regional"
  } else {
    saida <- "Departamento Regional - Polo"
  }
  saida
})

output$PrimeiroSegmento <- renderUI({print(input$unidade)
